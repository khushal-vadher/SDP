...
void main() {
  ...
  */
  /*
        ...
        const name = ‘Kashyap ';
        message += name; // 'Hello my name is Kashyap'
 
        final message = StringBuffer();
        message.write('Hello');
        message.write(' my name is ');
        message.write('Kashyap');
        message.toString(); // "Hello my name is Kashyap"
  ...
  */
  /*
        ...
        const name = "Kashyap ";
        const intro = "Hello , My name is $name"; //Hello my name is Kashyap
 
        const oneThird = 1 / 3;
        const sents = 'One third is $oneThird.'; //One third is 0.3333333333333333.
 
        final sents = 'One third is ${oneThird.toStringAsFixed(3)}.'; //One third is 0.333.
  */
  /*
  ...
  */
  /*
        ...
        var my_var = 42;
        my_var = "hello"; // valid in javascript not in dart
        // print(my_var); // Error: A value of type 'String' can't be assigned to a variable of type 'int'.
 
        var answer = my_var * 3; // runtime error
 
        dynamic my_var = 42;
        my_var = 'hello'; // we can change value using dynamic
        print(my_var);
 
        var my_var; // defaults to dynamic
        my_var = 42; // OK
        my_var = 'hello'; // OK
