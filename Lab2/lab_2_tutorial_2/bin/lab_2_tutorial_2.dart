...
/*
//TYPE INTERFACE
//There’s no need to tell Dart that 10 is an integer.Dart makes num an int. Type safety still applies, though:
  var num = 10;
  num = 15;
//Trying to set numto a double will result in an error. Your program won’t even compile.
  num = 3.14159;
*/
...
//CONSTANTS
  //CONST CONSTATNS
    ...
    my_con = 9;
    Error: Can't assign to the const variable 'my_con'.
    print(my_con);
  //FINAL CONSTANTS
